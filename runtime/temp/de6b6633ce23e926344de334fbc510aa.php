<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\blog\public/../application/index\view\index\index.html";i:1560614625;}*/ ?>
<!-- <!DOCTYPE html>
<html class="han-la">
        ...
        <div id="preheader"></div>
            ...
            <nav id="main-nav" class="clearfix yahei">
                <ul id="menu" class="nav">
                    <li class="menu-item current-menu-item"><a title="
            " href="index.html">首页</a>
                    </li>
                    <li class="menu-item"><a title="
            " href="app/index/view/index/footer.html" aria-current="page">小脚印</a>
                    </li>
                    <li class="menu-item "><a title="
            " href="about.html">关于我~</a>
                    </li>
                    <li class="menu-item"><a title="
            " href="message.html">留言板</a>
                    </li>
                </ul>
            </nav>
            <div id="announcement"> <span><i class="fa fa-star"></i></span>
            </div>
        </header>
            ...
            <span class="love-count">
                2            </span></a>
                    ...
                    <article class="post-248 post type-post status-publish format-standard has-post-thumbnail hentry category-7 category-13 tag-19 tag-24">
                        <header class="entry-header">
                            <h2 class="entry-name">
            <a href="queryurlparameter.html" rel="bookmark">移动端-毕业怀旧页面</a>
        </h2>
                            <ul class="entry-meta">
                                <li class="time_meta"><i class="fa fa-clock-o"></i> 2018-06-01 18:17</li>
                                <li class="cat_meta"><i class="fa fa-pencil-square-o"></i>  <a href="#" rel="category tag">前端</a>,<a href="#" rel="category tag">项目</a>
                                </li>
                                <li class="comments_meta"><i class="fa fa-comments-o"></i>  <a href="#">暂无评论</a>
                                </li>
                                <li class="views_meta"><i class="fa fa-eye"></i>  <a>39 访问量</a>
                                </li>
                            </ul>
                        </header>
                        <div class="entry-content" itemprop="description">
                            <p>临近毕业，心血来潮，加上最近在学移动端，那就来个小实战案例吧</p>
                        </div>
                        <footer class="entry-footer clearfix"> <span class="tag-links in-list"><a href="#" rel="tag">前端</a><a href="#" rel="tag">项目</a></span>
                            <div class="post-more"> <a href="queryurlparameter.html">阅读全文</a>
                            </div>
                            <div class="post-love"> <a href="javascript:;" data-action="ding" data-id="248" class="favorite post-love-link " title="点个赞"><i class="fa fa-heart-o"></i>
            <span class="love-count">
                3            </span></a>
                            </div>
                        </footer>
