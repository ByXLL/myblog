<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\xampp\htdocs\blog\public/../application/index\view\index\footer.html";i:1562305152;}*/ ?>
﻿<!DOCTYPE html>
<html class="han-la">
...
<body class="nav-open">
    <div id="wrap">
        ...
        <header id="header" class="clearfix">
            ...
            <nav id="main-nav" class="clearfix yahei">
                <ul id="menu" class="nav">
                    ...
                    <li class="menu-item current-menu-item"><a title="" href="<?php echo url('index/footer'); ?>?page=1002">小脚印</a>
                    </li>
        ...
        <div id="container" class="clearfix">
            <div id="content">
                <div
                    class="page-template page-template-page-archives page-template-page-archives-php page page-id-9 elementor-default">
                    <article class="box post-9 page type-page status-publish hentry">
                        <header class="entry-header detail-page">
                            <h2 class="entry-name">
                                <a href="#" rel="bookmark">小脚印</a>
                            </h2>
                        </header>
                        <div class="entry-content" itemprop="description">
                            <div class="archives">
                                ...
                                <h3 class="m-title"> <?php echo date("Y-m",strtotime($vo['uploadtime'])); ?></h3>
                                <ul class="archives-monthlisting">
                                    <li style="background: none;">
                                        <a href="<?php echo url('index/detail'); ?>?id=<?php echo $vo['id']; ?>"><span><?php echo date("m-d",strtotime($vo['uploadtime'])); ?></span>
                                            <div class="atitle"><?php echo $vo['title']; ?></div>
                                        </a>
                                    </li>
                                </ul>
                                <?php endforeach; ?>
                        ...
                        <footer class="entry-footer clearfix"> <span class="tag-links">
                        </footer>
                    </article>
