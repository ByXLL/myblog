<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\xampp\htdocs\blog\public/../application/admin\view\index\password.html";i:1561340456;s:59:"C:\xampp\htdocs\blog\application\admin\view\layout\sub.html";i:1561989038;}*/ ?>
<meta charset="utf-8">
...
layui.define(["form", "upload"], function(t) {
    ...
    n.on("submit(setmypass)", function(t) {
      ...
      $.ajax({
        type: "POST",
        url:'<?php echo url("index/set_password"); ?>',
        data:{
          id:1
